(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["FredRTETinyMCE"] = factory();
	else
		root["FredRTETinyMCE"] = factory();
})(self, function() {
...
/***/ "./_build/assets/js/Plugins/RegisterPlugins.js":
/*!*****************************************************!*\
  !*** ./_build/assets/js/Plugins/RegisterPlugins.js ***!
  \*****************************************************/
...
/* harmony export */ });
/* harmony import */ var _modxlink_modxlink__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modxlink/modxlink */ "./_build/assets/js/Plugins/modxlink/modxlink.js");

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function (fred, pluginTools) {
  tinymce.PluginManager.add('modxlink', (0,_modxlink_modxlink__WEBPACK_IMPORTED_MODULE_0__.default)(fred, pluginTools));
});
...
var Data = /*#__PURE__*/function () {
  ...
  _createClass(Data, [{
    ...
    value: function parseData() {
      var elementData = this.getElementData();
      this.activeTab = elementData.tab;
      return _objectSpread(_objectSpread({}, this.initialData), elementData.data);
    }
  }, {
    key: "getElementData",
    value: function getElementData() {
      ...
      var data = {
        ...
        page: _objectSpread({}, this.initialData.page || {}),
        url: _objectSpread({}, this.initialData.url || {}),
        email: _objectSpread({}, this.initialData.email || {}),
        phone: _objectSpread({}, this.initialData.phone || {}),
        file: _objectSpread({}, this.initialData.file || {})
      };
      ...
      var linkType = this.element.dataset.fredLinkType;
      ...
      if (linkType === 'page') {
        ...
        if (data.page.page || data.page.anchor) {
          ...
          return {
            tab: 'page',
            data: _objectSpread(_objectSpread({}, data.global), {}, {
              page: _objectSpread({}, data.page)
            })
          };
        }
      }
      ...
      if (linkType === 'email') {
        if (url.slice(0, 7) === 'mailto:') {
          ...
          return {
            tab: 'email',
            data: _objectSpread(_objectSpread({}, data.global), {}, {
              email: _objectSpread({}, data.email)
            })
          };
        }
      }
      ...
      if (linkType === 'phone') {
        if (url.slice(0, 4) === 'tel:') {
          ...
          return {
            tab: 'phone',
            data: _objectSpread(_objectSpread({}, data.global), {}, {
              phone: _objectSpread({}, data.phone)
            })
          };
        }
      }
...
var Link = /*#__PURE__*/function () {
  ...
  _createClass(Link, [{
    key: "insertLink",
    value: function insertLink(linkText, attributes) {
      this.editor.insertContent(this.editor.dom.createHTML('a', attributes, linkText));
    }
  }, {
    key: "editLink",
    value: function editLink(linkText, attributes) {
    ...
    key: "handleLink",
    value: function handleLink(linkText, attributes) {
      if (!this.element) return this.insertLink(linkText, attributes);
      return this.editLink(linkText, attributes);
    }
  }, {
    key: "savePage",
    value: function savePage(data) {
      if (!data.page.page && !data.page.anchor) return;

      var attributes = _objectSpread(_objectSpread({}, Link.getGeneralAttributes(data, 'page')), {}, {
        'data-fred-link-page': data.page.page
      });

      if (data.page.anchor) {
        attributes['data-fred-link-anchor'] = data.page.anchor;
        attributes.href = "".concat(data.page.url, "#").concat(data.page.anchor);
      } else {
    ...
    key: "saveUrl",
    value: function saveUrl(data) {
      if (!data.url.url) return;
      return this.handleLink(data.link_text, _objectSpread(_objectSpread({}, Link.getGeneralAttributes(data, 'url')), {}, {
        href: data.url.url
      }));
    }
  }, {
    ...
    value: function saveEmail(data) {
      ...
      var href = "mailto:".concat(data.email.to);
      var mailAttrs = [];
      ...
      return this.handleLink(data.link_text, _objectSpread(_objectSpread({}, Link.getGeneralAttributes(data, 'email')), {}, {
        href: href
      }));
    }
  }, {
    ...
    value: function savePhone(data) {
      ...
      return this.handleLink(data.link_text, _objectSpread(_objectSpread({}, Link.getGeneralAttributes(data, 'phone')), {}, {
        href: "tel:".concat(data.phone.phone)
      }));
    }
  }, {
    key: "saveFile",
    value: function saveFile(data) {
      ...
      return this.handleLink(data.link_text, _objectSpread(_objectSpread({}, Link.getGeneralAttributes(data, 'file')), {}, {
        href: data.file.file
      }));
    }
  }, {
    ...
    key: "getGeneralAttributes",
    value: function getGeneralAttributes(data, type) {
      var attributes = {
...
/***/ "./_build/assets/js/Plugins/modxlink/Unlink.js":
/*!*****************************************************!*\
  !*** ./_build/assets/js/Plugins/modxlink/Unlink.js ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "unlinkSelection": () => (/* binding */ unlinkSelection),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
...
var getSelectedElements = function getSelectedElements(rootElm, startNode, endNode) {
  var walker, node;
  var elms = [];
...
var unwrapElements = function unwrapElements(editor, elms) {
...
var getParentAnchorOrSelf = function getParentAnchorOrSelf(dom, elm) {
  var anchorElm = dom.getParent(elm, isLink);
  return anchorElm ? anchorElm : elm;
};

var getSelectedAnchors = function getSelectedAnchors(editor) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (unlinkSelection);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Data__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Data */ "./_build/assets/js/Plugins/modxlink/Data.js");
/* harmony import */ var _Link__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Link */ "./_build/assets/js/Plugins/modxlink/Link.js");
/* harmony import */ var _Unlink__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Unlink */ "./_build/assets/js/Plugins/modxlink/Unlink.js");



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function (fred, pluginTools) {
  var fredConfig = pluginTools.fredConfig,
      fetch = pluginTools.fetch,
      Choices = pluginTools.Choices;
  return function (editor, url) {
    var handleClick = function handleClick() {
      var dataHelper = new _Data__WEBPACK_IMPORTED_MODULE_0__.default(editor);
      var activeTab = 0;
      ...
      var linkState = node.nodeName == "A"; // Open window
      ...
      var win = editor.windowManager.open({
        ...
        buttons: [{
          ...
          onclick: function onclick() {
            if (linkState) {
              var el = editor.dom.getParent(editor.selection.getStart(), 'a[href]');
              editor.selection.select(el);
              (0,_Unlink__WEBPACK_IMPORTED_MODULE_2__.unlinkSelection)(editor);
            }
        ...
        onsubmit: function (tabPanel) {
          return function (e) {
            var link = new _Link__WEBPACK_IMPORTED_MODULE_1__.default(editor);
      ...
      var lookupCache = {};
      var initData = [];
      var templateInputChoices = new Choices(input, {
        removeItemButton: true
      });
      templateInputChoices.ajax(function (callback) {
        fetch("".concat(fredConfig.config.assetsUrl, "endpoints/ajax.php?action=get-resources&current=").concat(data.page.page), {
          ...
          if (json.data.current) {
            ...
            if (pageAnchorEl) {
              pageAnchorEl.innerText = fredConfig.lng('fredrtetinymce.block_on', {
                page: json.data.current.pagetitle
              });
            }
          }
      ...
      var serverLookup = function serverLookup() {
        ...
        if (query in lookupCache) {
          ...
          fetch("".concat(fredConfig.config.assetsUrl, "endpoints/ajax.php?action=get-resources&query=").concat(query), {
            credentials: 'same-origin',
            headers: {
              'X-Fred-Token': fredConfig.jwt
            }
      ...
      templateInputChoices.passedElement.addEventListener('choice', function (event) {
        ...
        if (pageAnchorEl) {
          pageAnchorEl.innerText = fredConfig.lng('fredrtetinymce.block_on', {
            page: event.detail.choice.label
          });
        }
      });
      templateInputChoices.passedElement.addEventListener('removeItem', function (event) {
        ...
        if (pageAnchorEl) {
          pageAnchorEl.innerText = fredConfig.lng('fredrtetinymce.block_on', {
            page: fredConfig.pageSettings.pagetitle
          });
        }
      });
    };
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Plugins_RegisterPlugins__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Plugins/RegisterPlugins */ "./_build/assets/js/Plugins/RegisterPlugins.js");
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function (fred, pluginTools) {
  var Finder = pluginTools.Finder;
  (0,_Plugins_RegisterPlugins__WEBPACK_IMPORTED_MODULE_0__.default)(fred, pluginTools);
  return function (el, config, onInit, onChange, onFocus, onBlur) {
    var promise = new Promise(function (resolve, reject) {
      setTimeout(function () {
        ...
        finalConfig.file_picker_callback = function (callback, value, meta) {
          var finder = new Finder(function (file, fm) {
            var url = file.url;
            var info = file.name;
...
//# sourceMappingURL=fredrtetinymce.min.js.map